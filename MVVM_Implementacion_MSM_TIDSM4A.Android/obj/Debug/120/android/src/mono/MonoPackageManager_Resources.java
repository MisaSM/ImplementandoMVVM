...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MVVM_Implementacion_MSM_TIDSM4A.Android.dll" comes first in this list. */
		"MVVM_Implementacion_MSM_TIDSM4A.Android.dll",
		"FormsViewGroup.dll",
		"MVVM_Implementacion_MSM_TIDSM4A.dll",
